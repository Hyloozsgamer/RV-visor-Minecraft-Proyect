...
public class VREyeFramebuffer {
    ...
    public boolean isMsaa() {
        return this.msaaSamples > 1 && this.msaaFramebufferId != -1;
    }
    ...
    public void blitResolvedToScreen(int winW, int winH) {
        RenderSystem.assertOnRenderThread();
        GlStateManager._colorMask(true, true, true, false);
        GlStateManager._disableDepthTest();
        GlStateManager._depthMask(false);
        GlStateManager._viewport(0, 0, winW, winH);
        ...
        GL30.glBlitFramebuffer(0, 0, this.width, this.height, 0, 0, winW, winH, GL11.GL_COLOR_BUFFER_BIT, GL11.GL_LINEAR);
        GlStateManager._glBindFramebuffer(GL30.GL_FRAMEBUFFER, 0);
    ...
    public void blitToScreen(int width, int height, boolean disableBlend) {
        this.blitResolvedToScreen(width, height);
    }
